...
const PopularProductCard = ({imgURL, name, detail}) => {
  return (
    <div className=' flex flex-1 flex-col w-full sm:w-full'>
      <img src={imgURL} alt={name} className=' w-[250px] h-[250px] rounded-md hover:w-[270px] hover:h-[270px]' />
      <div className=' mt-8 flex justify-start gap-2.5'>
        ...
        <p className=' mt-2 font-montserrat text-md leading-normal text-white-400 '>{detail}</p>
    </div>
  )
}
