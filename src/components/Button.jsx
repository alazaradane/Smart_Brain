...
const Button = ({label, iconURL, iconAlt, backgroundColor, borderColor, textColor, fullwidth, signOut, onClick, signup}) => {
  ...
  return (
    <button className={` flex justify-center items-center px-7 py-4 gap-2
      ...
      ${signup && ' bg-coral-blue rounded-lg p-0 mr-5 hover:bg-blue-600'}` }
      onClick={onClick}
      >
        {label}
        {iconURL && 
