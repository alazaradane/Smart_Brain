...
const SpecialOffer = () => {
  return (
    <section className=' flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container'>
      <div data-aos="fade-up-right" data-aos-duration="1000" className='items-center justify-center flex w-1/2 '>
        <img src={tiger}  className=' w-[1500px] h-[650px] rounded-xl'/>
      </div>
      <div data-aos="fade-up-left" data-aos-duration="1000" className=' flex flex-col  justify-start mt-12 max-sm:w-full w-1/2 '>
