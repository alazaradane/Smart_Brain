...
const Hero = ({onRouteChange}) => {
  ...
  return (
    ...
    >
      <div data-aos="fade-up" data-aos-duration="1000" className='relative flex w-2/5 flex-col justify-center items-start  max-xl:padding-x  pt-28 max-sm:w-full max-lg:w-full max-xl:w-full mb-20'>
        ...
        <div data-aos="zoom-in-up" data-aos-duration="1500"  className=' flex justify-start items-start gap-16 mt-20 flex-wrap w-full '>
          {statistics.map((stat)=>
          <div key={stat.label}>
      ...
      <div data-aos="fade-left" data-aos-duration="1000" className='relative w-full flex justify-center items-center  xl:min-h-screen  py-40  '>
        <HeroCard/>
      </div>
